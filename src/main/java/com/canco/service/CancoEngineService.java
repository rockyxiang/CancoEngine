...
/**
 * 
 * User: rocky Date: 13-7-7 Time: 下午2:18
 * 
 */
public interface CancoEngineService {
	 ...
	 * @return
	 */
	public List<CancoEngineDeployment> searchCancoEngineDeploymentsByBusiType(
			String busiType);
	 ...
	 * @return
	 */
	public InputStream resourceInputStream(String deploymentId,
	 ...
	 *            任务ID
	 * @return 
	 *         [{"taskName(环节名称)":"起草","taskId(当前任务ID)":"123","assinger":"张三[123]"
	 *         ,"startTime":"","endTime":""}]
	 */
